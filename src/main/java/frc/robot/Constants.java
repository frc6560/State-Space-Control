...
public final class Constants {
  ...
  /** First-pass flywheel model. Replace the inertia and gearing with measured robot values. */
  public static final class Flywheel {
    ...
    public static final double MOMENT_OF_INERTIA_KG_METERS_SQUARED = 0.0025;
    public static final double IDLE_RAD_PER_SECOND = 0.0;
    public static final double SHOOT_RAD_PER_SECOND = 450.0;
    public static final double SPEED_TOLERANCE_RAD_PER_SECOND = 12.0;
  }

  /** Readiness rules used by the high-level superstructure coordinator. */
  public static final class Coordination {
    private Coordination() {}

    public static final double ARM_ANGLE_TOLERANCE_RAD = Units.degreesToRadians(1.5);
    public static final double ARM_VELOCITY_TOLERANCE_RAD_PER_SECOND = Units.degreesToRadians(5.0);
    public static final double TURRET_ANGLE_TOLERANCE_RAD = Units.degreesToRadians(1.5);
    public static final double TURRET_VELOCITY_TOLERANCE_RAD_PER_SECOND = Units.degreesToRadians(8.0);
    public static final double READY_DEBOUNCE_SECONDS = 0.15;
    public static final double PREPARE_TIMEOUT_SECONDS = 3.0;
  }
}
